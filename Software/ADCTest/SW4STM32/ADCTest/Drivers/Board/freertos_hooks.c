...
//			log_force("Memory manage fault address: 0x%08x", SCB->MMFAR);
//		}
//		if (SCB->CFSR & SCB_CFSR_BFARVALID) {
//			log_force("BusFault address: 0x%08x", SCB->BFAR);
//		}
//		if (SCB->CFSR & SCB_CFSR_IACCVIOL) {
//			log_force("Instruction access violation");
//		}
//		if (SCB->CFSR & SCB_CFSR_DACCVIOL) {
//			log_force("Data access violation");
//		}
//		if (SCB->CFSR & SCB_CFSR_MUNSTKERR) {
//			log_force("Memory unstacking fault for return from exception");
//		}
//		if (SCB->CFSR & SCB_CFSR_MSTKERR) {
//			log_force("Memory stacking fault for exception entry");
//		}
...
//		}
//#endif
//		if (SCB->CFSR & SCB_CFSR_IBUSERR) {
//			log_force("Instruction bus error");
//		}
//		if (SCB->CFSR & SCB_CFSR_PRECISERR) {
//			log_force("Precise data bus error");
//		}
//		if (SCB->CFSR & SCB_CFSR_UNSTKERR) {
//			log_force("BusFault on unstacking for a return from exception");
//		}
//		if (SCB->CFSR & SCB_CFSR_STKERR) {
//			log_force("BusFault on stacking for exception entry");
//		}
...
//		}
//#endif
//		if (SCB->CFSR & SCB_CFSR_UNDEFINSTR) {
//			log_force("Undefined instruction");
//		}
//		if (SCB->CFSR & SCB_CFSR_INVSTATE) {
//			log_force("Invalid state");
//		}
//		if (SCB->CFSR & SCB_CFSR_INVPC) {
//			log_force("Invalid PC");
//		}
//		if (SCB->CFSR & SCB_CFSR_NOCP) {
//			log_force("No coprocessor");
//		}
//		if (SCB->CFSR & SCB_CFSR_STKERR) {
//			log_force("Stack error");
//		}
//		if (SCB->CFSR & SCB_CFSR_UNALIGNED) {
//			log_force("Unaligned access");
//		}
//		if (SCB->CFSR & SCB_CFSR_DIVBYZERO) {
//			log_force("Division by zero");
//		}
//	}
	log_force(
